        ...
        <div class="tab-holder">
            <div class="outerGraphWrapper">
                <div class="graphWrapper">
                    <statsgraph chart-id="statsgraph" class="graphAreaWrapper"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            currentWeather()
            {
                return this.getCurrentWeather(this.parkdata);
            },
            gridData()
            {
                return this.generateGridData(this.parkdata);
            },
        },
        methods: {
            ...
            setRealTimeData()
            {
                ...
                Windmill.getParkWeatherById(this.parkId)
                    .then((response) => {
                        //this also contains weather forecast data.
                        if (response.result) {
                            self.parkdata = response.weather;
            ...
            generateDataSets(weatherdata)
            {
                ...
                gradient.addColorStop(0, 'rgba(80,168,180,1)');
