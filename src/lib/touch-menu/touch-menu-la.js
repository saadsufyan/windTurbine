let TouchMenuLA = function (options) {
    let self,
        defaults,
        menuClassName = '',
        mask,
    ...
    TouchMenuLA.prototype.changeMenuPos = function (ev) {
    ...
    TouchMenuLA.prototype.setMaskOpacity = function (newMenuPos) {
        let opacity = parseFloat((newMenuPos / options.width) * options.maxMaskOpacity);
    ...
    TouchMenuLA.prototype.eventStartMask = function () {
        ...
        maskHammer.on('panmove', function (ev) {
    ...
    TouchMenuLA.prototype.close = function () {
        ...
        if (options.target.querySelector('.mdc-temporary-drawer__drawer')) {
            options.target.querySelector('.mdc-temporary-drawer__drawer').scrollTop = 0;
